...
if __name__ == '__main__':
    ...
    parser.add_argument("--curr_epoch", type=int, default=20)
    ...
    parser.add_argument("--dataset", help="data to train, [cmnist, cifar10, bffhq, waterbirds, waterbirds_noise, fairface]", default= 'waterbirds', type=str)
