...
```
python test.py --pretrained_path=/home/ulkar/debias-medimg/Learning-Debiased-Disentangled/log/cmnist/cmnist_0.5_ours/result --dataset=cmnist --percent=0.5pct --data_dir /home/ulkar/debias-medimg/Learning-Debiased-Disentangled/data/Dataset
