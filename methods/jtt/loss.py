...
class LossComputer:
    ...
    def update_stats(self,
        ...
        # worst-group loss
        self.worst_group_acc = self.avg_group_acc.min().item()
        self.worst_group_idx = self.avg_group_acc.argmin().item()
    ...
    def get_stats(self, model=None, args=None):
        ...
        # Worst-group (by acc)
        worst_group_idx = torch.argmin(self.avg_group_acc).item()
        stats_dict["worst_group_acc"] = self.avg_group_acc[worst_group_idx].item()
        stats_dict["worst_group_idx"] = worst_group_idx
